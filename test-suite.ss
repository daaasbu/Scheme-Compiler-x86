...
(valid '7 '() '#f
 ...
 (boolean? '#f) (boolean? '7) (null? '())
 (let ([t.4128 (cons '1 (cons '2 '()))]) (null? t.4128))
 (fixnum? '1234) (fixnum? '())
 (procedure? (lambda (x.4127) x.4127)) (procedure? '7)
 (<= '1 '8) (<= '8 '1) (<= '1 '1) (< '8 '1) (< '1 '8)
 (= '1 '1) (= '1 '0) (>= '8 '1) (>= '1 '8) (>= '1 '1)
                                 ...
                                 (if (< i.4086 n.4085)
                                     (begin
                                       ...
                                       (call
                                         ...
                                         n.4085))
                                     (void)))])
       (begin (call iota-fill!.4084 v.4083 '0 n.4082) v.4083))))
 (let ([x.4077 (cons '1 '())])
 ...
 (let ([t.4063 (cons '7 '10)])
   (letrec ([list4.4056 (lambda (a.4060 b.4059 c.4058 d.4057)
     ...
     (let ([pair.4062 t.4063] [vect.4061 (make-vector '3)])
       (call list4.4056 (set-car! pair.4062 '7)
         (set-cdr! pair.4062 '10) (vector-set! vect.4061 '0 '16)
         '()))))
                                                 ...
                                                 (if (< idx.12 '1)
                                                     ...
                                                     (+ (vector-ref
                                                        ...
                                                        (call
                                                          ...
                                                          (- idx.12
                                                             '1)))))])
                                  (call f.11 (vector-length vect.10))))])
         (call vector-sum.9 vect.1)))))
 (letrec ([a.4029 (lambda (u.4044 v.4043 w.4042 x.4041)
                    (if (= u.4044 '0)
                        (call b.4028 v.4043 w.4042 x.4041)
                        (call a.4029 (- u.4044 '1) v.4043 w.4042 x.4041)))]
          [b.4028 (lambda (q.4039 r.4038 x.4037)
                    (let ([p.4040 (* q.4039 r.4038)])
                      (call e.4026 (* q.4039 r.4038) p.4040 x.4037)))]
          [c.4027 (lambda (x.4036) (* '5 x.4036))]
          [e.4026 (lambda (n.4035 p.4034 x.4033)
                    (if (= n.4035 '0)
                        (call c.4027 p.4034)
                        (call o.4025 (- n.4035 '1) p.4034 x.4033)))]
          [o.4025 (lambda (n.4032 p.4031 x.4030)
                    (if (= '0 n.4032)
                        (call c.4027 x.4030)
                        (call e.4026 (- n.4032 '1) p.4031 x.4030)))])
   (let ([x.4045 '5]) (call a.4029 '3 '2 '1 x.4045)))
 (let ([t.4024 (cons
                 '5
   ...
   (call
     (letrec ([length.4022 (lambda (ptr.4023)
                             (if (null? ptr.4023)
                                 '0
                                 (+ '1
                                    (call length.4022 (cdr ptr.4023)))))])
       length.4022)
     t.4024))
 (letrec ([count-leaves.4020 (lambda (p.4021)
                               (if (pair? p.4021)
                                   (+ (call count-leaves.4020 (car p.4021))
                                      (call
                                        count-leaves.4020
                                        (cdr p.4021)))
                                   '1))])
   ...
   (letrec ([add1.4012 (lambda (n.4016) (+ n.4016 '1))]
            [map.4011 (lambda (f.4015 ls.4014)
                        (if (null? ls.4014)
                            '()
                            (cons
                              (call f.4015 (car ls.4014))
                              (call map.4011 f.4015 (cdr ls.4014)))))]
            [sum.4010 (lambda (ls.4013)
                        (if (null? ls.4013)
                            '0
                            (+ (car ls.4013)
                               (call sum.4010 (cdr ls.4013)))))])
     (let ([ls.4017 t.4019])
       (let ([ls.4018 (cons
                        '10
                        (cons '9 (cons '8 (cons '7 (cons '6 ls.4017)))))])
         (call sum.4010 (call map.4011 add1.4012 ls.4018))))))
 (let ([t.4009 (cons
                 '2
   ...
   (letrec ([list-ref.3991 (lambda (ls.4006 offset.4005)
            ...
            [expt.3987 (lambda (v.3998 w.3997)
                         (if (= w.3997 '0)
                             '1
                             (* v.3998
                                (call expt.3987 v.3998 (- w.3997 '1)))))]
                             ...
                             (if (null? sel.3995)
                                 ...
                                 (cons
                                   (call
                                     ...
                                     (car rand1.3994)
                                     (car rand2.3993))
                                   (call selector.3986 op*.3996
                                     (cdr sel.3995) (cdr rand1.3994)
                                     (cdr rand2.3993)))))]
            [sum.3985 (lambda (ls.3992)
                        (if (pair? ls.3992)
                            (+ (car ls.3992) (call sum.3985 (cdr ls.3992)))
                            '0))])
     (call
       sum.3985
       (call selector.3986
         ...
         t.4009 t.4008 t.4007))))
 (letrec ([thunk-num.3978 (lambda (n.3984)
                            (lambda () n.3984))]
          [force.3977 (lambda (th.3983) (call th.3983))]
          [add-ths.3976 (lambda (th1.3982 th2.3981 th3.3980 th4.3979)
                          (+ (+ (call force.3977 th1.3982)
                                (call force.3977 th2.3981))
                             (+ (call force.3977 th3.3980)
                                (call force.3977 th4.3979))))])
   (call add-ths.3976 (call thunk-num.3978 '5)
     (call thunk-num.3978 '17) (call thunk-num.3978 '7)
     (call thunk-num.3978 '9)))
 ...
 (call
   (lambda (y.3967)
     (call
       (lambda (f.3969) (call f.3969 (call f.3969 y.3967)))
 ...
 (let ([t.3960 '#t] [f.3959 '#f])
   (letrec ([even.3962 (lambda (x.3964)
                         (if (= x.3964 '0)
                             t.3960
                             (call odd.3961 (- x.3964 '1))))]
            [odd.3961 (lambda (x.3963)
                        (if (= x.3963 '0)
                            f.3959
                            (call even.3962 (- x.3963 '1))))])
     (call odd.3961 '13)))
   ...
   (letrec ([remq.3955 (lambda (x.3957 ls.3956)
                         (if (null? ls.3956)
                             ...
                             (if (eq? (car ls.3956) x.3957)
                                 (call remq.3955 x.3957 (cdr ls.3956))
                                 (cons
                                   (car ls.3956)
                                   (call
                                     remq.3955
                               ...
                               (let ([x.3949 (cons x.3954 (void))])
                                 (letrec ([param.3950 (lambda (set.3952
                                                        ...
                                                        (if set.3952
                                                            ...
                                                            (car x.3949)))])
                                   param.3950))))])
   (let ([p.3953 (call make-param.3947 '10)])
     (begin (call p.3953 '#t '15) (call p.3953 '#f '#f))))
 (let ([x.3946 '0])
 ...
 (letrec ([sub1.3937 (lambda (n.3939) (- n.3939 '1))]
          [fib.3936 (lambda (n.3938)
                      (if (= '0 n.3938)
                          ...
                          (if (= '1 n.3938)
                              '1
                              (+ (call fib.3936 (call sub1.3937 n.3938))
                                 (call
                                   fib.3936
                                   (call
                                     sub1.3937
                                     (call sub1.3937 n.3938)))))))])
   (call fib.3936 '10))
 (letrec ([ack.3933 (lambda (m.3935 n.3934)
                      (if (= m.3935 '0)
                          (+ n.3934 '1)
                          (if (if (> m.3935 '0) (= n.3934 '0) '#f)
                              (call ack.3933 (- m.3935 '1) '1)
                              (call
                                ack.3933
                                (- m.3935 '1)
                                (call ack.3933 m.3935 (- n.3934 '1))))))])
   (call ack.3933 '2 '4))
 ...
 (let ([t.3914 '#t] [f.3913 '#f])
   (let ([bools.3917 (cons t.3914 f.3913)]
     ...
     (letrec ([even.3919 (lambda (x.3921)
                           (if (= x.3921 '0)
                               (call id.3916 (car bools.3917))
                               (call odd.3918 (- x.3921 '1))))]
              [odd.3918 (lambda (y.3920)
                          (if (= y.3920 '0)
                              (call id.3916 (cdr bools.3917))
                              (call even.3919 (- y.3920 '1))))])
       (call odd.3918 '5))))
             ...
             (lambda (f.3896)
               (call
                 (lambda (g.3899)
                   (call
                     f.3896
                     (lambda (x.3900) (call (call g.3899 g.3899) x.3900))))
                 (lambda (g.3897)
                   (call
                     f.3896
                     (lambda (x.3898)
                       (call (call g.3897 g.3897) x.3898)))))))
                                  ...
                                  (if (null? ls.3905)
                                      ...
                                      (+ '1
                                         (call
                                           len.3904
                                           (cdr ls.3905))))))))
                          (call (car length.3901) (car test-ls.3895)))
                        len.3903))))))))))
 (letrec ([if-test.3887 (lambda (n.3890 x.3889 y.3888)
   ...
   (let ([q.3892 (make-vector '1)] [p.3891 (make-vector '1)])
     (begin
       ...
       (call if-test.3887 '3 q.3892 p.3891))))
 ...
 (letrec ([f.3871 (lambda (x.3877) (+ '1 x.3877))]
   ...
   (let ([x.3878 '80])
     (let ([a.3881 (call f.3871 x.3878)]
           [b.3880 (call g.3870 x.3878)]
           [c.3879 (call
                     h.3866
                     (call i.3867 (call j.3868 (call t.3869 x.3878))))])
       (* a.3881 (* b.3880 (+ c.3879 '0))))))
 (let ([f.3853 (lambda (x.3851) (+ '1 x.3851))]
       [g.3852 (lambda (x.3850) (- x.3850 '1))])
   (let ([x.3854 '80])
     (let ([a.3865 (call f.3853 x.3854)]
           [b.3864 (call g.3852 x.3854)]
                         ...
                         (call
                           ...
                           (letrec ([t.3860 (lambda (x.3862)
                                    ...
                                    [j.3859 (lambda (x.3861)
                                              (- x.3861 '1))])
                             (call j.3859 (call t.3860 x.3854)))))))])
       (* a.3865 (* b.3864 (+ c.3863 '0))))))
 (letrec ([fact.3846 (lambda (n.3847)
                       (if (= n.3847 '0)
                           '1
                           (let ([t.3848 (- n.3847 '1)])
                             (let ([t.3849 (call fact.3846 t.3848)])
                               (* n.3847 t.3849)))))])
   (call fact.3846 '10))
                          ...
                          (call
                            ...
                            (lambda (w.3842)
                              (call
                                ...
                                (- n.3841 '2)
                                (lambda (v.3843)
                                  (call k.3840 (+ w.3842 v.3843))))))))])
   (call fib.3839 '10 (lambda (x.3845) x.3845)))
 (letrec ()
                                                        ...
                                                        (let ([i.3822 (- i.3821
                                                          ...
                                                          (+ (* (vector-ref
                                                             ...
                                                             (call
                                                               f.3820
                                                               i.3822)))))])
                                   (call f.3820 (vector-length v1.3819)))
                                 '#f))])
     (cons
       (call dot-product.3823 t.3834 t.3832)
       (cons
         (call dot-product.3823 t.3830 t.3828)
         (cons (call dot-product.3823 t.3826 t.3824) '())))))
 (let ([t.3817 (cons
                 '1
   ...
   (letrec ([num-list?.3809 (lambda (ls.3813)
                              (if (null? ls.3813)
                                  ...
                                  (if (fixnum? (car ls.3813))
                                      (call num-list?.3809 (cdr ls.3813))
                                      '#f)))]
            [length.3808 (lambda (ls.3812)
                           (if (null? ls.3812)
                               '0
                               (+ (call length.3808 (cdr ls.3812)) '1)))]
     ...
     (let ([ls1.3815 t.3817] [ls2.3814 t.3816])
       (if (if (if (eq? (call num-list?.3809 ls1.3815) '#f)
                   '#f
                   '#t)
               (if (if (eq? (call num-list?.3809 ls2.3814) '#f) '#f '#t)
                   (= (call length.3808 ls1.3815)
                      (call length.3808 ls2.3814))
                   '#f)
               '#f)
           (call dot-prod.3807 ls1.3815 ls2.3814)
           '#f))))
 (let ([t.3806 (cons
                              ...
                              (let ([t.3804 (null? ls.3803)])
                                (if t.3804
                                    ...
                                    (if (fixnum? (car ls.3803))
                                        (call num-list?.3799 (cdr ls.3803))
                                        '#f))))]
            [map.3798 (lambda (f.3802 ls.3801)
                        (if (null? ls.3801)
                            '()
                            (cons
                              (call f.3802 (car ls.3801))
                              (call map.3798 f.3802 (cdr ls.3801)))))]
            [square.3797 (lambda (n.3800) (* n.3800 n.3800))])
     (let ([ls.3805 t.3806])
       (begin
         (if (call num-list?.3799 ls.3805)
             (set-car! ls.3805 (call map.3798 square.3797 ls.3805))
             (void))
         ls.3805))))
 (let ([t.3796 (cons
                 '1
   ...
   (letrec ([num-list?.3792 (lambda (ls.3794)
                              (if (null? ls.3794)
                                  ...
                                  (if (fixnum? (car ls.3794))
                                      (call num-list?.3792 (cdr ls.3794))
                                      '#f)))]
                                 ...
                                 (if (null? ls.3793)
                                     ...
                                     (* (car ls.3793)
                                        (call
                                          ...
                                          (cdr ls.3793)))))])
     (let ([ls.3795 t.3796])
       (if (call num-list?.3792 ls.3795)
           (call list-product.3791 ls.3795)
           '#f))))
 (letrec ([f.3778 (lambda (x.3790 y.3789)
                    (if x.3790
                        (call h.3776 (+ x.3790 y.3789))
                        (call g.3777 (+ x.3790 '1) (+ y.3789 '1))))]
             ...
             (lambda (f.3762)
               (call
                 (lambda (g.3765)
                   (call
                     f.3762
                     (lambda (x.3766) (call (call g.3765 g.3765) x.3766))))
                 (lambda (g.3763)
                   (call
                     f.3762
                     (lambda (x.3764)
                       (call (call g.3763 g.3763) x.3764)))))))
                                  ...
                                  (if (null? ls.3771)
                                      ...
                                      (+ '1
                                         (call
                                           len.3770
                                           (cdr ls.3771))))))))
                          (call (car length.3767) (car test-ls.3761)))
                        len.3769))))))))))
 (letrec ([curry-list.3752 (lambda (x.3755)
   ...
   (call
     append.3751
     (call (call (call (call curry-list.3752 '1) '2) '3) '4)
     (call (call (call (call curry-list.3752 '5) '6) '7) '8)))
     ...
     (letrec ([sub-and-continue.3735 (lambda (n.3741 acc.3740
       ...
       (let ([x.3745 '20]
             [fact.3744 (let ([seed.3742 '1])
                          (lambda (n.3743)
                            (call strange-fact.3734 n.3743 seed.3742)))])
         (let ([x.3746 (cons x.3745 (if '#f '#f (void)))])
           (letrec ([answer-user.3747 (lambda (ans.3748)
                                        (call
                                          ...
                                          ans.3748
                                          (car x.3746)))])
             (let ([give-fact5-answer.3750 (call fact.3744 '5)]
                   [give-fact6-answer.3749 (call fact.3744 '6)])
               (begin
                 (set-car!
                   x.3746
                   (call give-fact5-answer.3750 answer-user.3747))
                 (set-car!
                   x.3746
                   (call give-fact6-answer.3749 answer-user.3747))
                 (car x.3746)))))))))
                      ...
                      (let ([x.3723 (cons x.3726 (void))])
                        (let ([decrx.3725 (lambda ()
                          ...
                          (if (< (car x.3723) '2)
                              '1
                              (+ (begin
                                   (call (call decrx.3725) '1)
                                   (call fib.3722 (car x.3723)))
                                 (begin
                                   (call (call decrx.3725) '1)
                                   (call fib.3722 (car x.3723))))))))])
   (call fib.3722 '10))
 (let ([quote.3720 (lambda (x.3715) x.3715)]
       ...
       [plus.3721 '16])
   (let ([plus.3716 (cons plus.3721 (void))])
     (begin
       (set-car! plus.3716 (* '16 '2))
       (call
         cons.3717
         (call
           let.3719
           (call (call quote.3720 (lambda () '0)))
           (car plus.3716))
         (call
           if.3718
           (call quote.3720 (if '#f '#f '#t))
           '720000
           '-1)))))
 (let ([t.3702 (let ([tmp.3707 (make-vector '3)])
   ...
   (letrec ([sum-all.3695 (lambda (x.3701)
                            (if (fixnum? x.3701)
                                x.3701
                                (if (vector? x.3701)
                                    (call sum-vector.3694 x.3701)
                                    (if (pair? x.3701)
                                        (call sum-pair.3693 x.3701)
                                        (if (procedure? x.3701)
                                            (call
                                              sum-all.3695
                                              (call x.3701))
            ...
            [sum-vector.3694 (lambda (v.3697)
                               (letrec ([l.3698 (lambda (v.3700 i.3699)
                                 ...
                                 (call
                                   l.3698
                                   v.3697
                                   (vector-length v.3697))))]
            [sum-pair.3693 (lambda (p.3696)
                             (+ (call sum-all.3695 (car p.3696))
                                (call sum-all.3695 (cdr p.3696))))])
     (call sum-all.3695 (lambda () t.3702))))
                      ...
                      (letrec ([f.3657 (lambda (d.3660 n.3659 q.3658)
                                         (if (> n.3659 d.3660)
                                             ...
                                             (call
                                               ...
                                               n.3659
                                               (+ q.3658 '1))))])
                        (call f.3657 d.3656 n.3655 '0)))])
   (letrec ([alloc.3663 (lambda (n.3669)
                          (make-vector (call div.3654 n.3669 '8)))]
            [mref.3662 (lambda (x.3668 y.3667)
                         (if (vector? x.3668)
                             (vector-ref x.3668 (call div.3654 y.3667 '8))
                             (vector-ref
                               y.3667
                               (call div.3654 x.3668 '8))))]
            [mset!.3661 (lambda (x.3666 y.3665 z.3664)
                          (begin
                            (if (vector? x.3666)
                                (vector-set!
                                  x.3666
                                  (call div.3654 y.3665 '8)
                                  z.3664)
                                (vector-set!
                                  y.3665
                                  (call div.3654 x.3666 '8)
                                  z.3664))
                            (if '#f '#f (void))))])
     (letrec ([stack-push.3672 (lambda (self.3676 val.3675)
                                 (begin
                                   (call
                                     mset!.3661
                                     (call mref.3662 self.3676 '16)
                                     (* (call mref.3662 self.3676 '8) '8)
                                     val.3675)
                                   (call
                                     mset!.3661
                                     self.3676
                                     '8
                                     (+ (call mref.3662 self.3676 '8) '1))
                                   self.3676))]
              [stack-pop.3671 (lambda (self.3674)
                                (begin
                                  (call
                                    ...
                                    self.3674
                                    '8
                                    (- (call mref.3662 '8 self.3674) '1))
                                  (call
                                    mref.3662
                                    (call mref.3662 self.3674 '16)
                                    (* (call mref.3662 self.3674 '8)
                                       '8))))]
              [stack-top.3670 (lambda (self.3673)
                                (call
                                  mref.3662
                                  (call mref.3662 self.3673 '16)
                                  (* (- (call mref.3662 '8 self.3673) '1)
                                     '8)))])
       (let ([stack-new.3692 (void)] [invoke.3691 (void)])
         (let ([stack-new.3678 (cons stack-new.3692 (void))]
               [invoke.3677 (cons invoke.3691 (void))])
           (begin
             (let ([stack-new.3690 (let ([meths.3681 (call
                                                       alloc.3663
                                                       (* '3 '8))])
                                     (begin
                                       (call
                   ...
                   [invoke.3689 (lambda (obj.3680 meth-idx.3679)
                                  (call
                                    mref.3662
                                    (call mref.3662 obj.3680 '0)
                                    (* meth-idx.3679 '8)))])
               (begin
                 (set-car! stack-new.3678 stack-new.3690)
                 (set-car! invoke.3677 invoke.3689)))
             (let ([s1.3684 (call (car stack-new.3678) '10)])
               (begin
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '10)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '20)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '30)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '40)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '0)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '60)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '70)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '80)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '90)
                 (call (call (car invoke.3677) s1.3684 '0) s1.3684 '100)
                 (let ([s2.3685 (call (car stack-new.3678) '6)])
                   (begin
                     (call
                       (call (car invoke.3677) s2.3685 '0)
                       s2.3685
                       (call (call (car invoke.3677) s1.3684 '1) s1.3684))
                     (call (call (car invoke.3677) s1.3684 '1) s1.3684)
                     (call
                       (call (car invoke.3677) s2.3685 '0)
                       s2.3685
                     ...
                     (call
                       ...
                       (call (call (car invoke.3677) s1.3684 '1) s1.3684))
                     (let ([x.3686 (+ (call
                                        (call (car invoke.3677) s2.3685 '1)
                                        s2.3685)
                                      (call
                                        (call (car invoke.3677) s2.3685 '1)
                                        s2.3685))])
 ...
 (letrec ([dropsearch.3616 (lambda (cell.3637 tree.3636)
          ...
          [higher?.3614 (lambda (x.3633 y.3632 tree.3631)
                          (call
                            racethunks.3615
                            (call dropsearch.3616 x.3633 tree.3631)
                            (call dropsearch.3616 y.3632 tree.3631)))]
          [under?.3613 (lambda (x.3630 y.3629 tree.3628)
                         (call
                           racethunks.3615
                           (call dropsearch.3616 x.3630 y.3629)
                           (call dropsearch.3616 x.3630 tree.3628)))]
          [explore.3612 (lambda (x.3626 y.3625 tree.3624)
                          (if (if (pair? y.3625) '#f '#t)
                              '#t
                              (if (eq? x.3626 y.3625)
                                  '#f
                                  (let ([result.3627 (call
                                                       higher?.3614
                                                       x.3626
                                                       y.3625
                                                       tree.3624)])
       ...
       (begin
         (let ([zero?.3599 (lambda (x.3590) (= x.3590 '0))]
               ...
               [iota.3594 (lambda (n.3581)
                            (if (call (car zero?.3574) n.3581)
                                t.3591
                                (call
                                  (car snoc.3570)
                                  (call
                                    (car iota.3569)
                                    (call (car sub1.3573) n.3581))
                                  n.3581)))]
               [fib.3593 (lambda (n.3580)
                           (if (call (car zero?.3574) n.3580)
                               '0
                               (if (= n.3580 '1)
                                   '1
                                   (+ (call (car fib.3568) (- n.3580 '1))
                                      (call
                                        (car fib.3568)
                                        (- n.3580 '2))))))]
         ...
         (set-car!
           fib.3568
           (call (car bounded-memoize.3567) (car fib.3568) '5))
         (call
           (car map.3571)
           (car fib.3568)
           (call (car iota.3569) '10))))))
 (let ([a.1 (lambda (x.2)
              (lambda (y.3) (* x.2 (- y.3 '1))))])
   (let ([b.4 (lambda (w.5) (call (call a.1 '2) '4))])
     (call b.4 '6)))
 (call
   (lambda (x.1)
     (call
 ...
 (call
   ...
   (call
     ...
     (let ([z.3 (lambda (w.4) (+ w.4 '1))]) (call z.3 '7))))
 (let ([x.1 (lambda (z.3) (+ z.3 '1))]
       [y.2 (lambda (m.4) (+ m.4 '1))])
   (+ (call x.1 '2) (call y.2 '2)))
 ...
 (let ([a.1 '1])
   (letrec ([f.6 (lambda () (lambda (b.2) (+ a.1 b.2)))]
            [f.7 (lambda (c.3)
                   (lambda (d.4 e.5)
                     (+ (+ d.4 (call (call f.6) c.3)) e.5)))])
     (call (call f.7 a.1) (call (lambda () a.1)) a.1)))
                 ...
                 (if (vector? v.2)
                     (let ([length.4 (vector-length v.2)])
                       (if (fixnum? x.1)
                           ...
                           '#f))
                     '#f))])
   (call fill.5 '3 (make-vector '10)))
 (call
   (lambda (x.1)
     (call x.1 (call (lambda (y.2) (if y.2 '#f '#t)) '#t)))
   (lambda (z.3) z.3))
 (begin
   (lambda (x.1) (begin x.1))
   (begin
     (let ([x.2 '1] [x.3 (lambda () '1)])
       (if (eq? x.2 (null? x.3))
           (let ()
             (let ([y.14 (lambda () (+ x.2 x.2))])
               (call
                 (lambda (y.15 y.16) (begin (vector? y.15) (fixnum? y.16)))
                 (call y.14)
                 (call y.14))))
           (let ([x.4 (let ([x.5 (call
                                   (lambda (x.6 x.7)
                                     (if (< x.6 x.7)
                                         (+ x.2 x.6)
                                         (+ x.2 x.7)))
                        ...
                        (call
                          (lambda (x.8)
                            (<= (call (lambda (x.9) x.8) '13) (+ x.2 x.8)))
                          (call x.3)))]
                 [y.10 (letrec ([f.11 (lambda (y.12) (+ y.12 (call x.3)))])
                         (call f.11 '13))])
             (if (< '9 '14)
                 (null? (call (lambda () '())))
 ...
 (letrec ([depth.1 (lambda (ls.2)
                     (if (null? ls.2)
                         ...
                         (if (pair? (car ls.2))
                             (let ([l.4 (call
                                          (lambda (m.6) (+ m.6 '1))
                                          (call depth.1 (car ls.2)))]
                                   [r.5 (call depth.1 (cdr ls.2))])
                               (if (< l.4 r.5) r.5 l.4))
                             (call depth.1 (cdr ls.2)))))])
   (call
     depth.1
     (cons
       '1
 ...
 (call
   (lambda (y.2)
     (call
       (lambda (f.1) (call f.1 (call f.1 y.2)))
       (lambda (x.3) (+ x.3 '1))))
   '3)
 (letrec ([divide.1 (lambda (pred?.2 ls.3)
                      (if (null? ls.3)
                          '()
                          (call divideh.4 pred?.2 ls.3 '() '())))]
          [divideh.4 (lambda (pred?.8 ls.9 left.5 right.6)
                       (if (null? ls.9)
                           (cons left.5 (cons right.6 '()))
                           (if (call pred?.8 (car ls.9))
                               (call divideh.4 pred?.8 (cdr ls.9)
                                 (cons (car ls.9) left.5) right.6)
                               (call divideh.4 pred?.8 (cdr ls.9) left.5
 ...
 (letrec ([fold.0 (lambda (proc.1 base.2 ls.3)
                    (if (null? ls.3)
                        ...
                        (call
                          proc.1
                          (car ls.3)
                          (call fold.0 proc.1 base.2 (cdr ls.3)))))])
   (call
     fold.0
     (lambda (x.4 y.5) (* x.4 y.5))
     '1
    ...
    (let ([quote.3720 (lambda (x.3715) x.3715)]
      ...
      (let ([plus.3716 (cons plus.3721 (void))])
        (begin
          (set-car! plus.3716 (* '16 '2))
          (cons.3717
            (let.3719 ((quote.3720 (lambda () '0))) (car plus.3716))
